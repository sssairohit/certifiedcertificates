        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="w-[292px] flex-shrink-0 px-4">
            <button
              ...
              className="p-2 rounded-none text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-950"
            >
              {theme === 'light' 
          ...
          <div className="w-[292px] flex-shrink-0 px-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-none leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-[1.2rem] dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400"
