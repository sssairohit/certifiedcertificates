    ...
    <aside className="hidden lg:block w-[292px] bg-gray-50 border-l border-gray-200 p-4 overflow-y-auto dark:bg-gray-950 dark:border-gray-800">
      ...
      {certification && certification.content && certification.content.length > 0 && (
        <div className="border-t border-gray-200 dark:border-gray-800 pt-4 mt-4">
          <h3 id="toc-heading" className="text-[1.0rem] font-semibold text-gray-800 mb-4 dark:text-gray-200">On this page</h3>
              ...
              {certification.content.map((section) => (
                <li key={section.id}>
                  <a
                    ...
                    className={`block text-[1.0rem] transition-colors duration-200 ease-in-out border-l-2 pl-3 rounded-r-md focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-indigo-500 dark:focus-visible:ring-offset-gray-950 ${
                      activeTocId === section.id
                        ? 'border-indigo-500 text-indigo-600 font-semibold dark:border-indigo-400 dark:text-indigo-400'
